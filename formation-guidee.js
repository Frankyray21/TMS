...
(function () {
  ...
  function renderSommaire() {
    ...
    return '<div><section style="position:relative;overflow:hidden;border-bottom:1px solid #1e293b;background:radial-gradient(120% 100% at 80% -10%,#16202f 0%,#0a0e17 55%)">'
      + '<div style="position:relative;max-width:1120px;margin:0 auto;padding:52px 28px 44px;display:flex;flex-wrap:wrap;gap:44px;align-items:center;justify-content:space-between">'
      ...
      + '<h1 style="font-family:\'Barlow Condensed\',sans-serif;font-weight:800;text-transform:uppercase;letter-spacing:.01em;line-height:1.02;font-size:clamp(2.3rem,5vw,3.5rem);margin:0 0 16px">La prévention des TMS,<br><span style="color:#ef5a5c">pas à pas.</span></h1>'
      + '<p style="max-width:540px;color:#cbd5e1;font-size:1.1rem;margin:0 0 24px">Une formation découpée en <strong style="color:#fff">notions courtes</strong> : une page par notion, dans l\'ordre. À la fin de chaque module, un mini-quiz. Ton attestation t\'attend au bout.</p>'
